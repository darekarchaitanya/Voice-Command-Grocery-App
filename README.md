...
| Edge | ✅ Full | WebKit Speech API support |
| Safari | ✅ Full | iOS 14.5+ required |
| Firefox | ⚠️ Limited | Speech API has limited support |
...
- **Railway**: `npm run dev`
- **Render**: Use Node.js start command
- **Self-hosted**: Install Node.js and run `npm run build && npm start`

### Environment Variables
Currently, no environment variables are required. The app works with default settings.

## Performance Optimizations

- **Code Splitting**: Automatic with Next.js app router
- **Image Optimization**: Next.js Image component with lazy loading
- **CSS**: Tailwind CSS v4 with minimal bundle size
- **Voice Recognition**: Async processing to prevent UI blocking
...
- Ensure your browser supports the Web Speech API (Chrome, Edge, Safari)
- Grant microphone permissions when prompted
- Check that you're speaking clearly and in English
- Ensure en-IN language is available on your device
...
### Cart Not Persisting
- Cart state is stored in React Context (not persisted across refreshes)
- To add persistence, integrate localStorage or a database

## Contributing

This is a demo application. To make changes:
...
**Built with v0 by Vercel** - The AI-powered web development platform
